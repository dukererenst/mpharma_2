...
import com.genesys.mpharma.entity.setting.CompanyBranch;
...
@SessionScoped
public class CompanyBranchController implements Serializable, MPharmaMethods {
    ...
    public void saveMethod() {
        idGenerator.uniqueEntityId(companyBranch);
        if (mPharmaService.save(companyBranch) != null) {
            Msg.successSave();
            clearMethod();
        } else {
            Msg.failedSave();
    ...
    public void editMethod(EntityModel em) {
        companyBranch = (CompanyBranch) em;
    }
    ...
    @Override
    public List findAll() {
        return mPharmaService.findAll(CompanyBranch.class);
    }
